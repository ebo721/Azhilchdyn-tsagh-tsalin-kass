  ...
  const result = await client.query(`
    ...
    signature AS (
      ...
      WHERE columns.table_schema = 'public'
        AND (
           columns.table_name IN ('journal_entries', 'journal_lines', 'receivables', 'receivable_allocations')
      ...
      WHERE namespace.nspname = 'public'
        AND (
           relation.relname IN ('journal_entries', 'journal_lines', 'receivables', 'receivable_allocations')
