  ...
  const result = await client.query(`
    ...
    signature AS (
      ...
      WHERE columns.table_schema = 'public'
        AND (
           columns.table_name IN ('journal_entries', 'journal_lines', 'receivables', 'receivable_allocations', 'meal_schedule_slots', 'meal_schedule_entries')
      ...
      WHERE namespace.nspname = 'public'
        AND (
           relation.relname IN ('journal_entries', 'journal_lines', 'receivables', 'receivable_allocations', 'meal_schedule_slots', 'meal_schedule_entries')
