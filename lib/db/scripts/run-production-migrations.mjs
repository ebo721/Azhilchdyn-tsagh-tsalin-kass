    ...
    WITH managed_columns(table_name, column_name) AS (
      VALUES
        ...
        ('inventory_purchases', 'journal_entry_id'),
          ...
          ('meal_edit_requests', 'id'),
          ('meal_edit_requests', 'meal_id'),
          ('meal_edit_requests', 'requester_id'),
          ('meal_edit_requests', 'previous_name'),
          ('meal_edit_requests', 'previous_category'),
          ('meal_edit_requests', 'proposed_name'),
          ('meal_edit_requests', 'proposed_category'),
          ('meal_edit_requests', 'status'),
          ('meal_edit_requests', 'approved_by'),
          ('meal_edit_requests', 'requested_at'),
          ('meal_edit_requests', 'decided_at'),
      ...
      VALUES
        ...
        ('journal_lines_entry_idx'),
         ...
         ('meal_schedule_entries_meal_id_idx')
          ...
          ,('meal_edit_requests_pending_meal_idx')
    ),
    signature AS (
      SELECT
        'column' AS kind,
      ...
      WHERE columns.table_schema = 'public'
        AND (
           columns.table_name IN ('journal_entries', 'journal_lines', 'receivables', 'receivable_allocations', 'meal_schedule_slots', 'meal_schedule_entries', 'inventory_material_requests', 'inventory_material_request_items', 'meal_edit_requests')
      ...
      WHERE namespace.nspname = 'public'
        AND (
            relation.relname IN ('journal_entries', 'journal_lines', 'receivables', 'receivable_allocations', 'meal_schedule_slots', 'meal_schedule_entries', 'inventory_material_requests', 'inventory_material_request_items', 'meal_edit_requests')
