...
function Router() {
  ...
  useEffect(() => {
    ...
    if (role === 'viewer' && !['/employees', '/attendance', '/hour-balance', '/payroll', '/cash', '/bank-transactions', '/bank-transactions/journal-review', '/operating-expenses', '/inventory', '/fixed-assets', '/journal'].includes(location)) navigate('/employees', { replace: true });
