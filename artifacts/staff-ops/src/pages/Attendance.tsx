...
export function AttendancePage() {
  ...
  const filteredEmployees = shiftFilter === 'all'
    ? activeEmployees
    : shiftEmployees.filter((employee) =>
        (plans.data ?? []).some((plan) => plan.employeeId === employee.id && String(plan.shiftId) === shiftFilter));
